...
return [
    ...
    'attributes'             => [
        ...
        'source_amount' => 'مبلغ التحويل',
        'transfer_cost' => 'تكلفة التحويل',
        'notes' => 'الملاحظات',
        'opening_balance' => 'الرصيد الافتتاحي',
        'adjustmentAmount' => 'المبلغ',
        'adjustmentNotes' => 'سبب التعديل',
        'adjustmentDirection' => 'نوع التعديل',
        'withdrawAmount' => 'مبلغ السحب',
        'withdrawNotes' => 'ملاحظات السحب',
        'profitDistributionAmount' => 'مبلغ التوزيع',
        'profitDistributionNotes' => 'ملاحظات التوزيع',
        'profitDistributionToAccountId' => 'الحساب المستلم',
        'initial_customer_pay_amount' => 'المبلغ المدفوع من العميل',
        'receiver_name' => 'اسم المستلم',
        'payment_amount' => 'مبلغ الدفعة',
        'transfer_proof_path' => 'إثبات التحويل',
        'newRule.commission_amount' => 'قيمة العمولة',
        'newRule.min_amount' => 'الحد الأدنى للمبلغ',
        'newRule.max_amount' => 'الحد الأقصى للمبلغ',
        'branch' => 'الفرع',
